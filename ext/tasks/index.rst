...
The goal of this pycore extension is to abstract all these worries away from you.

Recipes
-------

A simple background task in a :class:`~pycore.ext.commands.Cog`:

.. code-block:: python3

    from pycore.ext import tasks, commands
...
.. attributetable:: pycore.ext.tasks.Loop

.. autoclass:: pycore.ext.tasks.Loop()
    :members:
...
.. autofunction:: pycore.ext.tasks.loop
