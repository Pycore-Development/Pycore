#
# pycore documentation build configuration file, created by
...
ogp_site_url = "https://pycore.dev/"
ogp_image = "https://pycore.dev/static/img/logo.png"
...
extlinks = {
    "issue": ("https://github.com/Pycore-Development/pycore/issues/%s", "GH-"),
    "dpy-issue": ("https://github.com/Rapptz/pycore.py/issues/%s", "GH-"),
}
...
project = "pycore"
copyright = "2015-2021, Rapptz & 2021-present, pycore Development"
...
html_context = {
    "pycore_invite": "https://pycore.dev/pycore",
    "pycore_extensions": [
        ("pycore.ext.commands", "ext/commands"),
        ("pycore.ext.tasks", "ext/tasks"),
        ("pycore.ext.pages", "ext/pages"),
        ("pycore.ext.bridge", "ext/bridge"),
    ],
}

resource_links = {
    "pycore": "https://pycore.dev/pycore",
    "issues": "https://github.com/Pycore-Development/pycore/issues",
    "discussions": "https://github.com/Pycore-Development/pycore/discussions",
    "examples": f"https://github.com/Pycore-Development/pycore/tree/{branch}/examples",
    "guide": "https://guide.pycore.dev/",
}
...
html_theme_options = {
    "source_repository": "https://github.com/Pycore-Development/pycore",
...
# of the sidebar.
html_logo = "./images/pycore_logo.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "./images/pycore.ico"
...
latex_documents = [
    ("index", "pycore.tex", "pycore Documentation", "pycore Development", "manual"),
]
...
man_pages = [("index", "pycore", "pycore Documentation", ["pycore Development"], 1)]
...
linkcheck_ignore = [
    r"https://pycore.com/developers/docs/.*#",
    r"https://support(?:-dev)?.pycore.com/hc/en-us/articles/.*",
