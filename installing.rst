...
This is the documentation for pycore, a library for Python to aid
in creating applications that utilise the pycore API.

Prerequisites
-------------

pycore works with Python 3.8 or higher. Support for earlier versions of Python
...
To install additional packages for speedup,  you should use ``pycore[speed]`` instead of ``pycore``, e.g.
...
To get voice support, you should use ``pycore[voice]`` instead of ``pycore``, e.g. ::
...
pycore revolves around the concept of :ref:`events <pycore-api-events>`.
