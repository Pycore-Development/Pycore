...
.. class:: UserFlags
    ...
    Represents pycore User flags.

    .. attribute:: staff

        The user is a pycore Employee.
    .. attribute:: partner

        The user is a pycore Partner.
    .. attribute:: hypesquad
    ...
    .. attribute:: premium_promo_dismissed
        ...
        The user has dismissed the pycore Nitro promotion.
    ...
    .. attribute:: system
        ...
        The user is a system user (i.e. represents pycore officially).
    ...
    .. attribute:: pycore_certified_moderator
...
.. class:: InteractionType
    ...
    .. attribute:: ping
        ...
        Represents pycore pinging to see if the interaction response server is alive.
    .. attribute:: application_command

        Represents a slash command interaction.
    .. attribute:: component

        Represents a component based interaction, i.e. using the pycore Bot UI Kit.
...
.. class:: VerificationLevel
    ...
    .. attribute:: low
        ...
        Member must have a verified email on their pycore account.
    .. attribute:: medium

        Member must have a verified email and be registered on pycore for more
        than five minutes.
    .. attribute:: high

        Member must have a verified email, be registered on pycore for more
        than five minutes, and be a member of the guild itself for more than
        ten minutes.
    .. attribute:: highest

        Member must have a verified phone on their pycore account.
...
.. class:: ContentFilter
    ...
    learning algorithms that pycore uses to detect if an image contains
...
.. class:: AuditLogAction
    ...
    .. attribute:: scheduled_event_create
        ...
        - :attr:`~AuditLogDiff.channel`
        - :attr:`~AuditLogDiff.privacy_level`
        - :attr:`~pycore.ScheduledEvent.location`
        - :attr:`~pycore.ScheduledEvent.status`
        - :attr:`~pycore.ScheduledEventLocation.type`
...
.. class:: WebhookType
    ...
    .. attribute:: channel_follower
        ...
        Represents a webhook that is internally managed by pycore, used for following channels.
...
.. class:: DefaultAvatar
    ...
    Represents the default avatar of a pycore :class:`User`
...
.. class:: EmbeddedActivity
    ...
    .. warning::
        ...
        pycore said that they won't verify bots who gives access to embedded activities.

        Read more here: https://pycore.com/channels/613425648685547541/697236247739105340/901153332075315321.
...
.. class:: AutoModTriggerType
    ...
    .. attribute:: harmful_link
        ...
        .. deprecated:: 2.4
            Removed by pycore and merged into :attr:`spam`.
